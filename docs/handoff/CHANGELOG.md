...
## 2026-09-14 工作区整理与线上信息核对

- 核对正式站：/extension、/extension/guide 和当前入口均为 1.1.5；旧版直接下载 URL 仍返回 200。本地工作区已清理旧包，待下一次明确发布后同步删除线上直链。
- 主工作区已对齐 origin/main / 06e73c3；受保护的 PRD、设计、评审交付物和宣传片源文件单独保留。
