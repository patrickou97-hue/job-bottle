  ...
  return (
    <div className="observatory-page extension-guide space-y-14">
      <section className="page-hero border-b border-[color:var(--line-ghost)] pb-8">
        ...
        <a href="https://pan.baidu.com/s/1q9gVenToSLL5x5tXZzYLig?pwd=SXZS" target="_blank" rel="noreferrer" className="gold-button pressable inline-flex h-11 w-fit items-center gap-2 rounded-lg px-4 text-sm font-semibold">
