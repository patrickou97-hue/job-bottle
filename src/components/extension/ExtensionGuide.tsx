      ...
      <section className="page-hero border-b border-[color:var(--line-ghost)] pb-8">
        <div className="max-w-4xl">
          ...
          <div className="mt-5 max-w-3xl space-y-2 text-sm leading-7 text-ink-secondary">
            <p>当前版本 1.1.0，适用于 Chrome、Edge 及其他 Chromium 浏览器。</p>
            ...
            <p>下载后请完整解压。1.1.0 会先稳定扫描页面并识别岗位与 ATS 结构，再把每一段经历与所选简历中的对应记录绑定；日期和重复字段写入后都会回读校验。AI 可以基于简历证据归纳表达，但不会虚构经历、数字或替你做敏感选择。验证码、密码和最终提交仍由你处理。</p>
          </div>
        </div>
      </section>
