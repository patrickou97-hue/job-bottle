...
const STATUS_STYLE: Partial<Record<ApplicationStatus, string>> = {
  opened: "shadow-[0_0_18px_rgba(18,41,78,0.28)]",
...
export function OpportunityStar({
  ...
  return (
    ...
    >
      ...
      <span className="pointer-events-none absolute left-1/2 top-full z-30 mt-2 hidden w-44 -translate-x-1/2 rounded-2xl bg-[#12294E]/72 px-3 py-2 text-left text-xs leading-5 text-ink-secondary shadow-[0_18px_48px_rgba(0,0,0,0.32)] backdrop-blur-xl group-hover:block group-focus-within:block">
