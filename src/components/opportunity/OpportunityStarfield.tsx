    ...
    <section className="relative overflow-hidden p-1">
      ...
      <div className="grid gap-5 xl:grid-cols-[minmax(0,1fr)_330px]">
        <div className="relative h-[420px] overflow-hidden rounded-[18px] bg-black/10 xl:h-[520px]">
          <div className="absolute inset-0 opacity-20 [background-image:radial-gradient(circle,rgba(53,103,168,.26)_0_1px,transparent_1.5px)] [background-size:96px_96px]" />
            ...
            if (!item.job) {
              return (
                <button
                  key={item.id}
                  type="button"
                  className="absolute flex items-center justify-center rounded-full bg-nebula-blue/10 text-xs font-medium text-ink-secondary shadow-[0_0_18px_rgba(53,103,168,0.18)] transition hover:scale-[1.05] hover:bg-nebula-blue/16 hover:text-nebula-silver"
                  style={{
                    width: item.size,
                    height: item.size,
