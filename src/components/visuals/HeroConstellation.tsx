  ...
  return (
    <div className="relative mx-auto aspect-[1.05] w-full max-w-[460px]">
      <svg
        aria-hidden="true"
        viewBox="0 0 460 440"
        className="h-full w-full drop-shadow-[0_28px_70px_rgba(3,7,18,0.55)]"
      >
        <defs>
          <radialGradient id="heroGlow" cx="50%" cy="42%" r="58%">
            <stop offset="0%" stopColor="#D6E4FF" stopOpacity="0.24" />
            <stop offset="48%" stopColor="#7DD3FC" stopOpacity="0.08" />
            <stop offset="100%" stopColor="#030712" stopOpacity="0" />
          </radialGradient>
          <linearGradient id="bottleLine" x1="115" x2="343" y1="108" y2="382">
            <stop stopColor="#D6E4FF" stopOpacity="0.82" />
            <stop offset="0.55" stopColor="#7DD3FC" stopOpacity="0.42" />
            <stop offset="1" stopColor="#E7C77B" stopOpacity="0.2" />
          </linearGradient>
          <linearGradient id="orbitLine" x1="28" x2="420" y1="52" y2="344">
            <stop stopColor="#B8C7FF" stopOpacity="0" />
            <stop offset="0.5" stopColor="#7DD3FC" stopOpacity="0.44" />
            <stop offset="1" stopColor="#F3DFA2" stopOpacity="0.08" />
          </linearGradient>
        </defs>
        ...
        <path
          ...
          strokeWidth="1.4"
        />
        <circle cx="258" cy="299" r="5.5" fill="#F3DFA2" opacity="0.78" />
        <circle cx="226" cy="327" r="3.5" fill="#7DD3FC" opacity="0.75" />
        <circle cx="291" cy="340" r="3" fill="#D6E4FF" opacity="0.68" />
        <circle cx="320" cy="279" r="2.8" fill="#B8C7FF" opacity="0.74" />
      </svg>
