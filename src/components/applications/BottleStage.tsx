          ...
          return (
            <button
              ...
              style={{
                ...
                border: selectedId === application.id ? "1px solid rgba(243,198,77,.64)" : "1px solid transparent",
              }}
...
function drawBottleAtmosphere(context: CanvasRenderingContext2D, width: number, height: number) {
  ...
  glow.addColorStop(0, "rgba(243,198,77,0.1)");
...
function getStarPalette(status: ApplicationStatus) {
  const palettes: Record<ApplicationStatus, {
    ...
    opened: {
      alpha: 0.86,
      haloScale: 0.72,
      haloInner: "rgba(216,225,239,0.36)",
      haloMid: "rgba(74,98,131,0.22)",
      haloOuter: "rgba(16,38,74,0)",
      fillStart: "#EDF2F8",
      fillMid: "#6A82A2",
      fillEnd: "#10264A",
      stroke: "rgba(216,225,239,0.6)",
    },
    applied: {
      alpha: 0.84,
      haloScale: 0.76,
      haloInner: "rgba(216,225,239,0.36)",
      haloMid: "rgba(30,59,102,0.2)",
      haloOuter: "rgba(30,59,102,0)",
      fillStart: "#D8E1EF",
      fillMid: "#56739C",
      fillEnd: "#10264A",
      stroke: "rgba(237,242,248,0.52)",
    },
    written_test: {
      alpha: 0.88,
      haloScale: 0.8,
      haloInner: "rgba(255,249,227,0.46)",
      haloMid: "rgba(243,198,77,0.28)",
      haloOuter: "rgba(243,198,77,0)",
      fillStart: "#FFF9E3",
      fillMid: "#D8A62F",
      fillEnd: "#1E3B66",
      stroke: "rgba(255,249,227,0.62)",
    },
    first_round: {
      alpha: 0.9,
      haloScale: 0.84,
      haloInner: "rgba(255,249,227,0.46)",
      haloMid: "rgba(243,198,77,0.3)",
      haloOuter: "rgba(243,198,77,0)",
      fillStart: "#FFF9E3",
      fillMid: "#E7B631",
      fillEnd: "#1E3B66",
      stroke: "rgba(255,249,227,0.58)",
    },
    second_round: {
      alpha: 0.93,
      haloScale: 0.88,
      haloInner: "rgba(255,249,227,0.5)",
      haloMid: "rgba(243,198,77,0.34)",
      haloOuter: "rgba(243,198,77,0)",
      fillStart: "#FFF9E3",
      fillMid: "#E7B631",
      fillEnd: "#1E3B66",
      stroke: "rgba(255,249,227,0.66)",
    },
    final_round: {
      alpha: 0.96,
      haloScale: 0.92,
      ...
      fillMid: "#E0B13A",
      fillEnd: "#10264A",
      stroke: "rgba(255,249,227,0.7)",
    },
    offer: {
      alpha: 1,
      haloScale: 0.96,
      haloInner: "rgba(255,225,132,0.62)",
      haloMid: "rgba(216,166,47,0.4)",
      haloOuter: "rgba(216,166,47,0)",
      fillStart: "#FFF4C6",
      fillMid: "#C9973C",
      fillEnd: "#6F4D12",
      stroke: "rgba(255,238,169,0.84)",
    },
    rejected: {
      alpha: 0.42,
      haloScale: 0.58,
      haloInner: "rgba(155,170,192,0.18)",
      haloMid: "rgba(74,98,131,0.12)",
      haloOuter: "rgba(16,38,74,0)",
      fillStart: "#9BAAC0",
      fillMid: "#4A6283",
      fillEnd: "#10264A",
      stroke: "rgba(216,225,239,0.24)",
    },
    withdrawn: {
      alpha: 0.36,
      haloScale: 0.54,
      haloInner: "rgba(155,170,192,0.16)",
      haloMid: "rgba(16,38,74,0.1)",
      haloOuter: "rgba(6,19,40,0)",
      fillStart: "#9BAAC0",
      fillMid: "#10264A",
      fillEnd: "#061328",
      stroke: "rgba(216,225,239,0.22)",
    },
  };
