...
function getStarPalette(status: ApplicationStatus) {
  const palettes: Record<ApplicationStatus, {
    ...
    first_round: {
      ...
      haloScale: 0.84,
      haloInner: "rgba(255,249,227,0.46)",
      haloMid: "rgba(76,120,181,0.3)",
      haloOuter: "rgba(76,120,181,0)",
      fillStart: "#E7EEF7",
      fillMid: "#4C78B5",
      fillEnd: "#244A7C",
      stroke: "rgba(231,238,247,0.58)",
    },
    second_round: {
      alpha: 0.93,
      haloScale: 0.88,
      haloInner: "rgba(255,249,227,0.5)",
      haloMid: "rgba(95,143,203,0.34)",
      haloOuter: "rgba(95,143,203,0)",
      fillStart: "#E7EEF7",
      fillMid: "#5F8FCB",
      fillEnd: "#244A7C",
      stroke: "rgba(231,238,247,0.66)",
    },
    final_round: {
      alpha: 0.96,
      haloScale: 0.92,
      ...
      haloOuter: "rgba(111,157,210,0)",
      fillStart: "#E7EEF7",
      fillMid: "#6F9DD2",
      fillEnd: "#12294E",
      stroke: "rgba(231,238,247,0.7)",
    },
    offer: {
      alpha: 1,
      haloScale: 0.96,
      haloInner: "rgba(255,225,132,0.62)",
      haloMid: "rgba(213,166,42,0.4)",
      haloOuter: "rgba(213,166,42,0)",
      fillStart: "#FFF4C6",
      fillMid: "#D5A62A",
      fillEnd: "#6F4D12",
