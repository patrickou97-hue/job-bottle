...
function getStarPalette(status: ApplicationStatus) {
  const palettes: Record<ApplicationStatus, {
    ...
    opened: {
      alpha: 0.78,
      haloScale: 0.72,
      haloInner: "rgba(201,197,228,0.28)",
      haloMid: "rgba(18,41,78,0.15)",
      haloOuter: "rgba(18,41,78,0)",
      fillStart: "#C9C5E4",
      fillMid: "#564A71",
      fillEnd: "#12294E",
      stroke: "rgba(201,197,228,0.4)",
      spark: "rgba(231,226,255,0.4)",
    },
    applied: {
      alpha: 0.84,
      haloScale: 0.76,
    ...
    written_test: {
      alpha: 0.88,
      haloScale: 0.8,
      haloInner: "rgba(231,226,255,0.38)",
      haloMid: "rgba(126,124,181,0.2)",
      haloOuter: "rgba(126,124,181,0)",
      fillStart: "#F1EFFF",
      fillMid: "#7E7CB5",
      fillEnd: "#564A71",
      stroke: "rgba(231,226,255,0.5)",
      spark: "rgba(241,239,255,0.52)",
    },
    first_round: {
      alpha: 0.9,
      haloScale: 0.84,
    ...
    second_round: {
      alpha: 0.93,
      haloScale: 0.88,
      haloInner: "rgba(231,226,255,0.46)",
      haloMid: "rgba(126,124,181,0.24)",
      haloOuter: "rgba(126,124,181,0)",
      fillStart: "#F1EFFF",
      fillMid: "#7E7CB5",
      fillEnd: "#564A71",
      stroke: "rgba(231,226,255,0.58)",
      spark: "rgba(241,239,255,0.6)",
    },
    final_round: {
      alpha: 0.96,
      haloScale: 0.92,
      haloInner: "rgba(242,222,233,0.5)",
      haloMid: "rgba(127,85,104,0.28)",
      haloOuter: "rgba(127,85,104,0)",
      fillStart: "#F1EFFF",
      fillMid: "#7F5568",
      fillEnd: "#564A71",
      stroke: "rgba(242,222,233,0.62)",
      spark: "rgba(241,239,255,0.66)",
    },
    offer: {
      alpha: 1,
      haloScale: 0.96,
      haloInner: "rgba(241,239,255,0.56)",
      haloMid: "rgba(126,124,181,0.34)",
      haloOuter: "rgba(126,124,181,0)",
      fillStart: "#F1EFFF",
      fillMid: "#7E7CB5",
      fillEnd: "#564A71",
      stroke: "rgba(241,239,255,0.74)",
      spark: "rgba(241,239,255,0.76)",
    },
    rejected: {
      alpha: 0.42,
      haloScale: 0.58,
