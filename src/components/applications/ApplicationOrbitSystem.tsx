        ...
        return (
          <span
            ...
            style={{
              ...
              marginLeft: -radius,
              marginTop: -radius,
              borderColor: active ? "rgba(29, 47, 79,0.48)" : `rgba(201,214,232,${0.08 + config.opacity * 0.2})`,
              boxShadow: active ? "0 0 28px rgba(29, 47, 79,0.18)" : "inset 0 0 18px rgba(18,41,78,0.03)",
            }}
          />
        );
      })}
