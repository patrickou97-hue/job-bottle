...
export function GalaxyChoice({
  ...
  return (
    <Link href={href} className="group relative min-h-[280px] overflow-hidden rounded-lg border-t border-white/[0.14] bg-[#12294E]/48 p-7 outline-none transition duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:-translate-y-0.5 hover:bg-[#24375C]/58 focus-visible:ring-2 focus-visible:ring-[color:var(--brand-blue)] sm:p-8">
      <Image
        src={imageSrc}
        alt=""
        fill
