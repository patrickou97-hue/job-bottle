...
export function GalaxyChoice({
  ...
  return (
    <Link href={href} className="group relative min-h-[280px] overflow-hidden rounded-lg border-t border-white/[0.14] bg-[#10264A]/48 p-7 outline-none transition duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] hover:-translate-y-0.5 hover:bg-[#1E3B66]/58 focus-visible:ring-2 focus-visible:ring-[color:var(--star-apricot)] sm:p-8">
      <Image
        src={imageSrc}
        alt=""
        fill
      ...
      />
      <span className="absolute inset-0 bg-[linear-gradient(180deg,rgba(6,19,40,0.08),rgba(6,19,40,0.78))]" />
