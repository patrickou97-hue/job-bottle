      ...
      <AnimatePresence initial={false}>
        {translating && translationProgress ? (
          <AiTaskProgress
            ...
            floating
            title={`正在生成${translationTarget}译本`}
          ...
          {resumes.map((resume) => {
            ...
            return (
              <button
                ...
                className={`resume-list-item resume-version-item min-w-0 px-4 py-3 text-left transition focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1D2F4F]/40 focus-visible:ring-inset ${selectedResume.id === resume.id ? "text-ink-primary" : "text-ink-secondary"}`}
