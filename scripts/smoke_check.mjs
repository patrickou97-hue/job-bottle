...
const SOURCE_INVARIANTS = [
  ...
  },
  {
    ...
    mustInclude: ["\"manifest_version\": 3", "\"version\": \"0.1.7\"", "\"activeTab\"", "\"scripting\"", "\"storage\"", "https://www.starjob.space/extension*", "https://www.starjob.space/*"],
  ...
  },
  {
    ...
    mustInclude: ["html {", "width: 380px", "body {", "width: 100%", "overflow-x: hidden", ".mode-group label:has(input:checked)", ".result-panel", ".progress-panel", "prefers-reduced-motion"],
  ...
  },
  {
    ...
    mustInclude: ["Manifest V3", "manifest.permissions.includes(\"cookies\")", "public", "downloads", "拾星网申助手-v0.1.7.zip"],
