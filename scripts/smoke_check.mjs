...
const SOURCE_INVARIANTS = [
  ...
  },
  {
    ...
    mustInclude: ["\"manifest_version\": 3", "\"version\": \"0.1.8\"", "\"activeTab\"", "\"scripting\"", "\"storage\"", "https://www.starjob.space/extension*", "https://www.starjob.space/*"],
  ...
  },
  {
    ...
    mustInclude: ["Manifest V3", "manifest.permissions.includes(\"cookies\")", "public", "downloads", "拾星网申助手-v0.1.8.zip"],
  ...
  },
  {
    ...
    mustNotInclude: ["public/downloads", "拾星网申助手-v0.1.8.zip", "SUPABASE_SERVICE_ROLE_KEY"],
