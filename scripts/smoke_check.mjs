...
const SOURCE_INVARIANTS = [
  ...
  },
  {
    ...
    mustInclude: ["AbortController", "22_000", "isResumePolishResult", "生成结果格式异常", "润色请求超时"],
  ...
  },
  {
    ...
    mustInclude: ["本地读取 · 智能复核 · 确认生成", "extractResumeFileText", "parseResumeTextLocally", "不会上传原文件", "进行结构复核", "英文简历", "中文简历", "直接导入本地结果", "导入复核结果", "即使复核超时或失败，当前结果仍会保留", "ResumeImportMode", "AbortController", "43_000", "当前网络不可用", "取消复核", "本地识别结果已保留"],
  ...
  },
  {
    ...
    mustInclude: ["createResumeTranslationSource", "requestResumeTranslation", "createResumeFromTranslation", "getEquivalentTemplateForLanguage", "linkedJobId: null", "photoDataUrl", "原简历未改动"],
  ...
  },
  {
    ...
    mustInclude: ["\"manifest_version\": 3", "\"version\": \"0.2.3\"", "\"activeTab\"", "\"scripting\"", "\"storage\"", "https://www.starjob.space/extension*", "https://www.starjob.space/*"],
  ...
  },
  {
    ...
    mustInclude: ["assets/wordmark.png", "alt=\"拾星\"", "网申助手", "本地读取简历 · 最终由你提交", "一键填写当前页面", "AI 智能填写", "处理进度", "modeHint", "unmatchedDetails", "footer-main-actions", "aria-hidden=\"true\""],
    mustNotInclude: ["<svg", "emoji"],
    label: "扩展弹窗使用拾星品牌与单层任务流结构",
  },
  {
    file: "browser-extension/starjob-resume-assistant/popup.css",
    mustInclude: ["html {", "width: 380px", "body {", "width: 100%", "overflow-x: hidden", "repeat(3, minmax(0, 1fr))", ".mode-group label:has(input:checked)", ".mode-hint[data-tone=\"warning\"]", ".mode-hint[data-tone=\"ai\"]", ".result-details", ".result-panel", ".progress-panel", "min-height: 36px", "prefers-reduced-motion"],
  ...
  },
  {
    ...
    mustInclude: ["/downloads/starjob-resume-assistant-v0.2.3.zip", "安装包由拾星官网直接提供", "最新版本 0.2.3", "按字段语义填写自我描述与经历描述", "多段经历的日期对应和顺序校验", "返回拾星并同步简历", "安装后刷新检测", "步骤 {String(index + 1).padStart(2, \"0\")}"],
    mustNotInclude: ["pan.baidu.com", "百度网盘提取码", "最新版本 0.1.9"],
    label: "网申助手下载页与安装教程共用 0.2.3 官网安装包",
  },
  {
