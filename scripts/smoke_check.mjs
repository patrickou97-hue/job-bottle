...
const SOURCE_INVARIANTS = [
  ...
  },
  {
    ...
    mustInclude: ["<span className=\"block\">一份简历，</span>", "<span className=\"block\">投向更多可能</span>", "调用拾星网申工具填写常用字段。你只需检查后提交。", "starjob-resume-assistant-iphone17pm.png", "iPhone 17 Pro Max", "获取安装包", "安装后刷新检测", "window.location.reload()", "LEGACY_COMPATIBLE_VERSION = \"0.1.7\"", "0.1.7 可继续同步与填写；需要新版描述识别时可升级 0.1.9", "最新版本 0.1.9", "https://pan.baidu.com/s/1q9gVenToSLL5x5tXZzYLig?pwd=SXZS"],
