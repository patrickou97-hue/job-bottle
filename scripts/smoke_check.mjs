...
const SOURCE_INVARIANTS = [
  ...
  },
  {
    ...
    mustInclude: ["\"manifest_version\": 3", "\"activeTab\"", "\"scripting\"", "\"storage\"", "https://www.starjob.space/extension*", "https://www.starjob.space/*"],
  ...
  },
  {
    ...
    mustInclude: ["正在读取可见表单字段", "analysisOnly", "aiOnly", "extension-match", "matchToken", "智能复核", "SMART_MATCH_TIMEOUT_MS", "SMART_MATCH_MAX_FIELDS", "deterministicConfidence", "AbortController", "立即填写", "后台复核", "aiFieldMappings"],
  ...
  },
  {
    ...
    mustInclude: ["assets/wordmark.png", "alt=\"拾星\"", "网申助手", "安全填写", "一键填写当前页面", "本次处理", "footer-main-actions", "aria-hidden=\"true\""],
    mustNotInclude: ["<svg", "emoji"],
    label: "扩展弹窗使用拾星品牌与单层任务流结构",
  },
  {
    file: "browser-extension/starjob-resume-assistant/popup.css",
    mustInclude: [".mode-group label:has(input:checked)", ".result-panel", ".progress-panel", "prefers-reduced-motion", "width: min(380px, 100vw)"],
    mustNotInclude: ["linear-gradient(135deg"],
    label: "扩展弹窗以开放工作面、分隔线和状态色呈现且支持减少动态效果",
  },
  {
    file: "src/components/extension/ExtensionHubClient.tsx",
    mustInclude: ["一份简历，投向更多可能", "常见网申字段按页面顺序填入", "starjob-resume-assistant-iphone17pm.png", "iPhone 17 Pro Max", "获取安装包", "https://pan.baidu.com/s/1WhabI64zCSOXyn4zIAKMsw?pwd=SXZS"],
    mustNotInclude: ["简历写一次，网申少重复", "starjob-resume-assistant-popup.png", "https://pan.baidu.com/s/18t2FPlnjktr3zTG9eE1k2g?pwd=SXZS"],
    label: "网申助手首屏使用更克制的价值表达与带灵动岛的设备实机展示",
  },
  {
    file: "src/components/extension/ExtensionGuide.tsx",
    mustInclude: ["https://pan.baidu.com/s/1WhabI64zCSOXyn4zIAKMsw?pwd=SXZS", "百度网盘提取码：SXZS"],
    mustNotInclude: ["https://pan.baidu.com/s/18t2FPlnjktr3zTG9eE1k2g?pwd=SXZS"],
    label: "网申助手下载页与安装教程共用最新百度网盘地址",
  },
  {
    file: "scripts/build_resume_extension.mjs",
    mustInclude: ["Manifest V3", "manifest.permissions.includes(\"cookies\")", "public", "downloads", "拾星网申助手-v0.1.6.zip"],
  ...
  },
  {
    ...
    mustNotInclude: ["public/downloads", "拾星网申助手-v0.1.6.zip", "SUPABASE_SERVICE_ROLE_KEY"],
...
const REQUIRED_FILES = [
  ...
  "public/downloads/starjob-resume-assistant-v0.1.6.zip",
